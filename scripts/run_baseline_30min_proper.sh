#!/bin/bash
# run_baseline_30min_proper.sh - Baseline comparison script for PROPER STUDY

BINARY="binaries/cgc_cadet_00001_instrumented"
OUTPUT_DIR="data/outputs_baseline_proper"
INPUT_DIR="data/inputs_proper"
DURATION="30m"

echo "================================================================"
echo "BASELINE AFL++ CAMPAIGN (30 Minutes) - PROPER STUDY"
echo "Binary: $BINARY"
