#!/bin/bash
# run_baseline_60min.sh - Baseline comparison script (60 Minutes)

BINARY="binaries/cgc_cadet_00001_instrumented"
OUTPUT_DIR="data/outputs_baseline_60min"
INPUT_DIR="data/inputs_cgc_cadet_00001"
DURATION_SEC=3600

echo "================================================================"
echo "BASELINE AFL++ CAMPAIGN (60 Minutes)"
echo "Binary: $BINARY"
...
echo "[*] AFL++ running (PID $AFL_PID). Waiting for 60 minutes..."
...
while [ $(date +%s) -lt $END_TIME ]; do
    ...
    if [ -f "$STATS_FILE" ]; then
        ...
        # Memory is harder to match exactly, but we'll stick to process mem for now
